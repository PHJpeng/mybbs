                ...
                <form action="/index.php" method="get">
                    ...
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">姓名:</th>
                            <td><input class="common-text" placeholder="查找姓名条件" name="uname" value="" id="" type="text"></td>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                       ...
                       <tr>
                       	...
                       	<td>
                       		<?php if ($v['auth']==1) { echo '超级管理员'; } else if ($v['auth']==2) { echo '管理员'; } else if ($v['auth']==3) { echo '普通会员'; } ?>
                       	</td>
                       	<td>
                       		<img src="/<?php echo getSm($v['uface']); ?> ">
                       	</td>
                       	<td><?= date('Y-m-d H:i:s', $v['created_at']) ?><td>
                       		<a class="link-update" href="/index.php?m=admin&c=user&a=edit&uid=<?=$v['uid']?>">修改</a>
                       		<a class="link-del" href="/index.php?m=admin&c=user&a=del&uid=<?=$v['uid']?>">删除</a></td>
                       	</tr><?php endforeach; ?>
                    </table>
